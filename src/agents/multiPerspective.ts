...
- OFF-SUBJECT OPTIONS: Every option must be plausible within the same subject (ideally the same topic) as the stem. If any option belongs to a different discipline entirely (e.g. "Measuring rainfall patterns" as a distractor under a political-theory stem), a student eliminates it without knowing the topic — flag it as a giveaway distractor.
