...
export const BankView: React.FC<BankViewProps> = ({
  ...
  return (
    <div style={{ padding: '20px 24px', maxWidth: 1040, margin: '0 auto' }}>
      {/* Provider health banner is now mounted globally at App root
          (ProviderHealthBanner) so the truth is visible on every tab,
          not just the Bank — and on the Bank's empty state too. The
          per-Bank "Image provider" toolbar button below remains for
          explicit re-pings. */}
